        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchCards_Cards_CardEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerCardEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoundCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoundCards_PlayerCards_PlayerCardEntityId",
                        column: x => x.PlayerCardEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchCards_CardEntityId",
                table: "MatchCards",
                column: "CardEntityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoundCards_PlayerCardEntityId",
                table: "RoundCards",
                column: "PlayerCardEntityId");
